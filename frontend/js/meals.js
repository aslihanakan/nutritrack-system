            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:14px">
                ${[
                    ...
                    <div>
                        ...
                        <input id="${id}" type="number" value="${val ?? ""}" style="
...
async function saveEditedMeal(id) {
    const updated = {
        meal_name: document.getElementById("editMealName").value.trim(),
        meal_type: document.getElementById("editMealType").value,

        calories: document.getElementById("editMealCalories").value.trim(),
        protein: document.getElementById("editMealProtein").value.trim(),
        carbs: document.getElementById("editMealCarbs").value.trim(),
        fat: document.getElementById("editMealFat").value.trim()
    };
